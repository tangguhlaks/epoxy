            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        <div class="d-inline">
                            <h4>Service</h4>
                            <span>Setting Service Hotel Nata</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                                ...
                                <div class="page-body">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="col-md-6">
                                                <button class="btn btn-primary" data-toggle="modal" data-target="#modalAdd">Add Service</button>
                                            </div>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>{{ $v->text }}</th>
                                                            <th>{{ $v->icon }}</th>
                                                            <td><img width="300px" src="images/services/{{$v->image}}" alt=""></td>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <input type="text" name="icon" placeholder="Icon" id="icon" class="form-control">
                <small class="text-danger">@error('title'){{$message}}@enderror</small>
            </div>
            <div class="form-group">
...
<div class="modal fade" id="modalDel{{ $v->id }}" tabindex="-1" role="dialog" aria-labelledby="modalDel{{ $v->id }}" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <a href="{{ url('delete-service/'.$v->id) }}" class="btn btn-primary">Delete</a>
        </div>
      </div>
    </div>
  </div>
