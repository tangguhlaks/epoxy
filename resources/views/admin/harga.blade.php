                ...
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Harga</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="page-body">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="col-md-6">
                                                <button class="btn btn-primary" data-toggle="modal" data-target="#modalAdd">Add Harga</button>
                                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            <th width="100px">#</th>
                                                            <th width="300px">Harga per meter</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th scope="row">{{ $no++ }}</th>
                                                            <th>Rp.{{ number_format($v->harga,'0','.','.') }}</th>
                                                            <td><img width="300px" src="images/harga/{{$v->image}}" alt=""></td>
                                                            <td>
