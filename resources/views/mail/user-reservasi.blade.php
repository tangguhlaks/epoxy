                ...
                <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td class="innerpadding borderbottom">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="h2">Hello {{ $data->name }}</td>
                                </tr>
                                <tr>
                                    <td class="bodycopy">your reservation has been submitted to us and we'll contact you as quickly as possible to complete your booking. If you have any question please don't hesitate to contact us via email natahotels@gmail.com or via phone number 0819828348</td>
                                    ...
                                    <td class="innerpadding details">
                                        ...
                                        <table class="col380" align="left" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                                <td>167282929993 (Sienna Azka Xaviera)</td>
                                            </tr>

                                            <tr>
                                                <td>Tranfer Via BCA</td>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                                <td>:</td>
                                                ...
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                                <td>67948383990 (Sienna Azka Xaviera)</td>
                                            </tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="bodycopy">
                                        ...
                                        Upload proof of payment in your book menu
